  ...
  return (
    <aside className="w-64 h-full glass-panel border-r border-white/[0.06] flex-col z-10 hidden md:flex">
      <div className="px-5 py-5 border-b border-white/[0.06]">
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-slate-400 leading-tight">Control de Asistencia</p>
          </div>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-300 ${
                isActive
                  ? "bg-indigo-500/15 text-indigo-300 border border-indigo-500/25 shadow-[0_0_12px_rgba(99,102,241,0.15)] font-semibold"
          ...
          {routesRRHH.map((route) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-300 ${
                  isActive
                    ? "bg-emerald-500/15 text-emerald-300 border border-emerald-500/25 shadow-[0_0_12px_rgba(16,185,129,0.15)] font-semibold"
                    : "text-slate-400 hover:text-slate-200 hover:bg-white/5 border border-transparent"
                }`}
              >
      ...
      <div className="p-4 space-y-2 border-t border-white/[0.06]">
        <Link
          href="/"
          className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-indigo-400 hover:bg-indigo-500/5 transition-colors w-full"
        >
